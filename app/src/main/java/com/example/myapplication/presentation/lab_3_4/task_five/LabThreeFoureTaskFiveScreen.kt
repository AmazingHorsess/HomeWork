...
fun LabThreeFoureTaskFiveScreen(navController: NavHostController) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                navigationIcon = {
                    IconButton(onClick = { navController.navigate(NavigationRoute.LabThreeFour.TaskFourLabThree.route) }) {
        ...
        content = {
            Column(
                ...
                ArrowButton(
                    ...
                    onClick = { navController.navigate(NavigationRoute.LabThreeFour.TaskSixLabThree.route) }
                )
